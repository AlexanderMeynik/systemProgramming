...
*/
 ...
 struct TMOP    //todo допилить                                  /*структ.стр.табл.маш.опер*/
  {
  ...
  } T_MOP [NOP+6]  =                                /*об'явление табл.маш.опер*/
    {
     ...
     {{'C','H',' ',' ',' '} , '\x78' , 4 , FRX} ,
     {{'S','T','H',' ',' '} , '\x60' , 4 , FRX} ,
     {{'L','H',' ',' ',' '} , '\x68' , 4 , FRX} , /*машинных                */
     {{'A','H',' ',' ',' '} , '\x6A' , 4 , FRX} , /*операций                */
     {{'S','H',' ',' ',' '} , '\x6B' , 4 , FRX} , /*                        */
    };
 ...
 struct TPOP                                      /*структ.стр.табл.пс.опeр.*/
  {
   ...
   int (*BXPROG) ()       ;                       /*указатель на подпр.обраб*/
  } T_POP [NPOP+6] =                                /*об'явление табл.псевдооп*/
    {
